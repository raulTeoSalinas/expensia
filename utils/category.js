...
const Category = [
  ...
  { id: 'transfer_out',  nameEN: 'Transfer Sent',     nameES: 'Transferencia enviada', type: 'e', icon: 'bank-transfer-out', isTransfer: true },
  ...
  { id: 'transfer_in',   nameEN: 'Transfer Received', nameES: 'Transferencia recibida', type: 'i', icon: 'bank-transfer-in', isTransfer: true },
]

export const TRANSFER_CATEGORY_IDS = ['transfer_out', 'transfer_in']
