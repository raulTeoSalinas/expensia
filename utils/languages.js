export const es = {
    ...
    iaTransactionsScreen: {
        ...
        helpImageTitle: "📷  Foto o PDF",
        helpImageBody: "Toma una foto de un recibo o ticket, o sube una imagen/PDF. La IA extrae el monto, categoría y fecha automáticamente.",
        ...
        errorPermissionCamera: "Activa el permiso de cámara en Ajustes.",
        errorPermissionGallery: "Activa el permiso de galería en Ajustes.",
        errorNoFile: "No se seleccionó ningún archivo.",
        orUploadHint: "O sube una foto o archivo para extraer la transacción",
        sourceCamera: "Cámara",
...
export const en = {
    ...
    iaTransactionsScreen: {
        ...
        helpCloseBtn: "Got it",
        helpImageTitle: "📷  Photo or PDF",
        helpImageBody: "Take a photo of a receipt or ticket, or upload an image/PDF. The AI automatically extracts the amount, category, and date.",
        ...
        errorPermissionCamera: "Enable camera permission in Settings.",
        errorPermissionGallery: "Enable gallery permission in Settings.",
        errorNoFile: "No file was selected.",
        orUploadHint: "Or upload a photo or file to extract the transaction",
        sourceCamera: "Camera",
